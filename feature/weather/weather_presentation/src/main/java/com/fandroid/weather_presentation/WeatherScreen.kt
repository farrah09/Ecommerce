...
import com.fandroid.weather_presentation.model.Forecast
import com.fandroid.weather_presentation.model.Hour
    ...
    Scaffold(
        ...
        content = { paddingValues ->
            Surface(
                ...
                WeatherScreenContent(modifier = modifier)
            }
        },
    )
}
...
fun WeatherScreenContent(
    ...
    WeatherSuccessState(modifier = modifier)
}
